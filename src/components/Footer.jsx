    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">FranchiseHub</h3>
            <p className="text-gray-300">
              Your trusted partner for franchise opportunities since 2010.
            </p>
          </div>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300">
              <p>123 Franchise Blvd</p>
              <p>Business District</p>
              <p>Email: info@franchisehub.com</p>
        ...
        <div className="mt-8 border-t border-gray-700 pt-6 text-center text-sm text-gray-400">
          <p>© 2025 FranchiseHub. All rights reserved.</p>
          <p className="mt-2">
